...
class TestSignaturesCLI:
    ...
    def test_signatures_flag_sets_config(
        ...
        result = self.runner.invoke(cli, ["process", "--signatures", "--output", "test.md"])
        ...
        assert mock_config.signatures_mode
    ...
    def test_no_signatures_flag_default_false(
        ...
        result = self.runner.invoke(cli, ["process", "--output", "test.md"])
        ...
        assert not mock_config.signatures_mode
    ...
    def test_signature_processor_integration(
        self, mock_load_config, mock_signature_processor_class
    ):
...
class TestSignaturesConfigIntegration:
    ...
    def test_config_signatures_not_in_args(self):
        ...
        assert config.signatures_mode  # Should remain unchanged
    ...
    def test_load_configuration_includes_signatures(self):
        ...
        with (
            patch("project2md.config.Config.from_yaml") as mock_from_yaml,
            ...
            load_configuration(None, cli_args)
...
class TestSignaturesEndToEnd:
    ...
    @patch("project2md.cli.GitHandler")
    @patch("project2md.cli.get_formatter")
    def test_signatures_processing_python_file(
        self, mock_get_formatter, mock_git_handler, tmp_path
    ):
