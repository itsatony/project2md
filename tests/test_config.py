...
from project2md.config import Config, ConfigError, GeneralConfig, OutputFormat
...
def sample_config_dict():
    return {
        ...
        "include": {"files": ["*.py", "*.md"], "dirs": ["src/", "docs/"]},
        "exclude": {"files": ["*.pyc", "*.log"], "dirs": ["__pycache__/", "build/"]},
    }
