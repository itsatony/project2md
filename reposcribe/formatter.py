...
class MarkdownFormatter:
    ...
    def _get_language_tag(file_path: Path) -> str:
        ...
        extensions = {
            ...
            '.test.ps1': 'powershell',
            '.test.psm1': 'powershell',
            '.test.psd1': 'powershell',
            '.test.rake': 'ruby',
            '.test.gemspec': 'ruby',
            '.test.podspec': 'ruby',
            '.test.thor': 'ruby',
            ...
            '.test.liquid': 'liquid',
            '.test.njk': 'nunjucks',
            '.test.nunjucks': 'nunjucks',
            '.test.jinja': 'jinja',
            '.test.jinja2': 'jinja',
            '.test.dot': 'dot',
            '.test.gv': 'dot',
            '.test.plantuml': 'plantuml',
            '.test.puml': 'plantuml',
            '.test.pu': 'plantuml',
            '.test.uml': 'plantuml',
            '.test.wsd': 'plantuml',
            ...
            '.test.cwl': 'cwl',
            '.test.wdl': 'wdl',
            '.test.nextflow': 'nextflow',
            '.test.nf': 'nextflow',
            '.test.snakemake': 'snakemake',
            '.test.smk': 'snakemake',
            '.test.robot': 'robot',
            '.test.feature': 'gherkin',
            '.test.story': 'gherkin',
            '.test.spec': 'gherkin',
            '.test.gherkin': 'gherkin',
